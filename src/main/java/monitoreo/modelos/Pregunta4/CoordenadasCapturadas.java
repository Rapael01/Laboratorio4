...
public static List<Punto> coordenadasCapturadas = new LinkedList<Punto>();
    ...
    public void mostrarLista(){
            for(int i=0 ;i<coordenadasCapturadas.size() ; i++){
                System.out.println(coordenadasCapturadas.get(i).getLatitud()+"-----"+coordenadasCapturadas.get(i).getLongitud());
                                                        }
                            }

    public void mostrarUltimaCoordenada(){
        System.out.println("ULTIMA COORDENADA CLICKEADA");
            System.out.println(coordenadasCapturadas.get(coordenadasCapturadas.size()-1).getLatitud()+"-----"+coordenadasCapturadas.get(coordenadasCapturadas.size()-1).getLongitud());
    }
